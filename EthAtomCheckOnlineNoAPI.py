...
while True:
    ...
    print(str(z),Fore.GREEN,str(ethaddr),Fore.YELLOW, str(privatekey),Fore.MAGENTA,str(ethVol),Fore.RED,'[Mmdrza.Com]',Style.RESET_ALL)
    z += 1
    if int(ethVol) > 0:
        ...
        f.write('\nADDRESS ETH      : ' + 0xa3df61dC71047912E2134222970884672117Fe2a)
